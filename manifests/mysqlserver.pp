...
$mysql_root_password=$sugarcrmstack::mysql_root_password,
  ...
  if ($galeracluster_galeracluster_enable == 1){
    ...
    elsif ($sugarcrmstack_ng::sugar_version == '7.9' or $sugarcrmstack_ng::sugar_version == '8.0') and ($mysql_server_use_pxc == false){
    ...
    elsif ($sugarcrmstack_ng::sugar_version == '7.9' or $sugarcrmstack_ng::sugar_version == '8.0') and ($mysql_server_use_pxc == true){
